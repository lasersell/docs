...
```bash
claude install-skill lasersell
```

### Option 3: Manual

Copy the `.claude/skills/lasersell/` directory from the [LaserSell SDK repository](https://github.com/lasersell/lasersell-sdk) into your project's `.claude/skills/` folder:

```bash
mkdir -p .claude/skills
cp -r path/to/lasersell-sdk/.claude/skills/lasersell .claude/skills/
```
