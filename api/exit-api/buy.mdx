...
| `amount_in_total`       | `number` | Yes      | Amount to spend in input-asset atomic units (e.g., lamports for SOL).       |
...
const request: BuildBuyTxRequest = {
  mint: "TOKEN_MINT_ADDRESS",
  user_pubkey: "YOUR_WALLET_PUBKEY",
  amount_in_total: 100_000_000, // 0.1 SOL in lamports
  slippage_bps: 2_000,
};
