...
<Tip>
**Using AI to code?** Add the [LaserSell MCP server](/ai-agents/mcp-server) to your editor so your AI assistant can search LaserSell documentation in real time. Works with Claude Code, Claude Desktop, Cursor, and Windsurf.
</Tip>
