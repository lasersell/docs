...
After you have created or imported your wallet (see [LaserSell Wallet](https://docs.lasersell.io/onboarding/lasersell-wallet)), the wizard will automatically proceed to the **Configuration** phase.
