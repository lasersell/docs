...
strategy:
  ...
  trailing_stop: "5%"        # exit when profit drops this % from its peak
  deadline_timeout: 120      # force exit after N seconds (0 to disable)
  sell_on_graduation: false  # auto-sell when token migrates to a new DEX

sell:
  slippage_pad_bps: 2000              # extra slippage on top of computed value (bps)
