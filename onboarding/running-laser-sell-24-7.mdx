---
title: "Running LaserSell 24/7 (with Tmux)"
description: "Configure your system to keep the LaserSell bot running continuously in the background without user intervention."
---
