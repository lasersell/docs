---
title: "Inicio rápido"
description: "Construye, firma y envía tu primera transacción de venta en menos de cinco minutos, luego configura un stream de auto venta."
---

## Prerrequisitos

- Una clave API de LaserSell ([obtén una aquí](/api/authentication)).
...
<Tip>
**¿Usas IA para programar?** Añade el [servidor MCP de LaserSell](/ai-agents/mcp-server) a tu editor para que tu asistente de IA pueda buscar documentación de LaserSell en tiempo real. Funciona con Claude Code, Claude Desktop, Cursor y Windsurf.
</Tip>
...
- [POST /v1/sell](/api/exit-api/sell): Esquema completo de solicitud y respuesta para transacciones de venta.
- [Exit Intelligence Stream](/api/stream/overview): Inmersión profunda en el WebSocket stream.
- [Firma de transacciones](/api/transactions/signing): Entiende el flujo de firma no custodial.
