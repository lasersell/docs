---
title: "البدء السريع"
description: "ابنِ ووقّع وقدّم أول معاملة بيع في أقل من خمس دقائق ثم أعد بث بيع تلقائي."
---

## المتطلبات

- مفتاح LaserSell API ([احصل على واحد هنا](/api/authentication)).
- ملف زوج مفاتيح Solana (مصفوفة JSON من البايتات).
- Node.js 18+ (لمثال TypeScript) أو بيئة التشغيل للغتك المفضلة.

<Tip>
**تستخدم الذكاء الاصطناعي للبرمجة؟** أضف [خادم LaserSell MCP](/ai-agents/mcp-server) إلى محررك حتى يتمكن مساعدك الذكي من البحث في وثائق LaserSell في الوقت الفعلي. يعمل مع Claude Code وClaude Desktop وCursor وWindsurf.
</Tip>
...
- [POST /v1/sell](/api/exit-api/sell): مخطط الطلب والاستجابة الكامل لمعاملات البيع.
- [بث ذكاء الخروج](/api/stream/overview): الغوص العميق في بث WebSocket.
- [توقيع المعاملات](/api/transactions/signing): فهم تدفق التوقيع غير الوصائي.
